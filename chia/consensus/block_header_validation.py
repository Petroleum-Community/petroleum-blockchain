...
def validate_unfinished_header_block(
    ...
    return required_iters, difficulty_coefficient, None  # Valid unfinished header block
...
def validate_finished_header_block(
    ...
    required_iters, difficulty_coefficient, validate_unfinished_err = validate_unfinished_header_block(
        constants,
        blocks,
